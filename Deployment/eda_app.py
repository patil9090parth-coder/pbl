...
def run_eda_app():
	...
	if submenu == "Descriptive":
		...
		with st.expander("Price Range Distribution"):
			img2 = Image.open(r"IMG\Price_Range_Distribution.png")
			st.image(img2)

		with st.expander("Price with respect to Floor"):
			img3 = Image.open(r"IMG\Property_Floor_Numbers_Bar.png")
			st.image(img3)
		
		with st.expander("Price with respect to Bedroom and Bathroom"):
			img4 = Image.open(r"IMG\BednBath_Price_Bar.png")
			st.image(img4)
		...
		with st.expander("Price with respect to SqFt Area"):
			img6 = Image.open(r"IMG\SqFt_Area_Price_Scatter.png")
			st.image(img6)

		with st.expander("Central Mumbai Property Price"):
			img7 = Image.open(r"IMG\Central Mumbai.png")
			st.image(img7)

		with st.expander("South Mumbai Property Price"):
			img8 = Image.open(r"IMG\South Mumbai.png")
			st.image(img8)

		with st.expander("Thane Property Price"):
			img9 = Image.open(r"IMG\Thane.png")
			st.image(img9)